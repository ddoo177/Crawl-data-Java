...
public class GetProducts {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (String groupURL : groupURLs) {
            Document collectionDoc = Jsoup.connect(groupURL).get();
            ...
            for (Element productDetail : products) {
                ...
                //Group
                item.setGroup(collectionDoc.getElementsByClass("text-black").get(0).text());
                ...
                for (Element e : product) {
                    ...
                    System.out.println(item.getGroup()+ ": " + item.getTitle());
                }
            }
        }
